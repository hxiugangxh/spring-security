package com.hxg.security.core.validate.core.impl;

import com.hxg.security.core.validate.core.*;
...
public abstract class AbstractValidateCodeProcessor<C extends ValidateCode> implements
    ...
    public ValidateCode create(ServletWebRequest request) throws Exception {
        ...
        ValidateCode code = save(request, validateCode);
     ...
     * @param validateCode
     */
    private ValidateCode save(ServletWebRequest request, C validateCode) {
