/*
package com.hxg.security.code;

import com.hxg.security.core.properties.SecurityProperties;
import com.hxg.security.core.validate.core.ImageCode;
import com.hxg.security.core.validate.core.ValidateCodeGenerator;
...
public class DemoImageCodeGenerator implements ValidateCodeGenerator {
    ...
    public ImageCode createImageCode(ServletWebRequest request) {
        ...
        log.info("我是复写后的 -- imageCodeGenerator");
        ...
        return new ImageCode(image, sRand, securityProperties.getValidateCode().getImage()
                .getExpireIn());
    }
