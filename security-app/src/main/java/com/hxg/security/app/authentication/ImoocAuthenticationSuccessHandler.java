...
public class ImoocAuthenticationSuccessHandler extends
    ...
    public void onAuthenticationSuccess(HttpServletRequest request, HttpServletResponse response,
        ...
        TokenRequest tokenRequest = new TokenRequest(MapUtils.EMPTY_MAP, clientId, clientDetails
				.getScope(), "custom");
        ...
        OAuth2AccessToken token = authorizationServerTokenServices.createAccessToken
